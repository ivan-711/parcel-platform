  ...
  return (
    ...
    >
      <button
        ...
        className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-violet-400 hover:bg-[#6B5AD6] text-[#0C0B0A] text-sm font-medium shadow-lg shadow-violet-400/20 transition-colors"
      >
        <Columns size={16} />
        Compare Selected
      </button>
