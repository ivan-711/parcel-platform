...
export function CloseDealModal({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => { if (!open) onClose() }}>
      <DialogContent className="border-white/[0.06] bg-[#22211D] sm:max-w-md">
        <motion.div
          {...shakeProps}
        ...
        >
          <DialogHeader>
            <div className="flex items-center gap-2">
              <DialogTitle className="text-[#F0EDE8]">Close Deal</DialogTitle>
          ...
          <div className="mt-4 space-y-4">
            {/* Closed Date */}
            <div>
              <label className="mb-1 block text-xs font-medium text-[#A09D98]">
                Closed Date
              </label>
              <input
                type="date"
                ...
                className="w-full rounded-lg border border-white/[0.06] bg-[#131210] px-3 py-2 text-sm text-[#F0EDE8] focus:border-[#8B7AFF]/50 focus:outline-none focus:ring-1 focus:ring-[#8B7AFF]/20"
              />
              {errors.closedDate && (
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-white/[0.06] bg-[#131210] px-3 py-2 text-sm text-[#F0EDE8] placeholder:text-[#5C5A56] tabular-nums focus:border-[#8B7AFF]/50 focus:outline-none focus:ring-1 focus:ring-[#8B7AFF]/20"
              />
              {errors.closedPrice && (
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full rounded-lg border border-white/[0.06] bg-[#131210] px-3 py-2 text-sm text-[#F0EDE8] placeholder:text-[#5C5A56] focus:border-[#8B7AFF]/50 focus:outline-none focus:ring-1 focus:ring-[#8B7AFF]/20 resize-none"
              />
            </div>
            ...
            <button
              ...
              className="w-full rounded-lg bg-gradient-to-r from-[#8B7AFF] to-[#6C5CE7] px-4 py-2.5 text-sm font-medium text-[#0C0B0A] hover:opacity-90 transition-opacity disabled:opacity-50"
            >
